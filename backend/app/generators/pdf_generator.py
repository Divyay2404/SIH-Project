...
def build_study_guide_pdf(course_data: dict, output_filepath: str = None) -> str:
    """
    ...
    """
    # If no custom filename is passed, derive it automatically from the course title
    ...
    # Subtitle line: Course Code and Module (uses fallbacks if not provided)
    ...
    # Fixed Metadata line: Target Audience is always B.Tech CSE, Author is always Study Co-Pilot
    ...
    # 2. Key Definitions Section (Rendered only if definitions exist)
    ...
    # 3. Practice Questions Section (2 / 5 / 10 Marks - Rendered only if questions exist)
